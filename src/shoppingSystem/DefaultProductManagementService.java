...
private static DefaultProductManagementService instance;
	...
	private static void initProducts() {
		products = new Product[] {
				new GreatProduct(1, "Hardwood Oak Suffolk Internal Door", "Doors", 109.99),
				new GreatProduct(2, "Oregon Cottage Interior Oak Door", "Doors", 179.99),
				new GreatProduct(3, "Oregon Cottage Horizontal Interior White Oak Door", "Doors", 189.99),
				new GreatProduct(4, "4 Panel Oak Deco Interior Door", "Doors", 209.09),
				new GreatProduct(5, "Worcester 2000 30kW Ng Combi Boiler Includes Free Comfort+ II controller", "Boilers", 989.99),
				new GreatProduct(6, "Glow-worm Betacom 4 30kW Combi Gas Boiler ERP", "Boilers", 787.99),
				new GreatProduct(7, "Worcester 2000 25kW Ng Combi Boiler with Free Comfort+ II controller", "Boilers", 859.99),
